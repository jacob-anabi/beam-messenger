    ...
    public class ConsolePane extends JPanel implements CommandListener, Terminal {
        ...
        public ConsolePane() {
            ...
            if (firstStart){
              try{
                if(!cmd.isRunning()){
                  cmd.execute("java -Djavax.net.ssl.trustStore=truststore -Djavax.net.ssl.trustStorePassword=trustword SSLClient");
                }
                else{
                  cmd.send("java -Djavax.net.ssl.trustStore=truststore -Djavax.net.ssl.trustStorePassword=trustword SSLClient");
                  firstStart = false;
                }
              }catch(Exception en){}
            }
            ...
            am.put("insert-break", new AbstractAction() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    try {
                        ...
                        Logger.getLogger(MessageConsole.class.getName()).log(Level.SEVERE, null, ex);
                    }
